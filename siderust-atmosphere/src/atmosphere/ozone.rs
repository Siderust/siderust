...
use qtty::Unit;
use siderust_numerics::provenance::Provenance;
use siderust_spectra::spectra::interp::{Interpolation, OutOfRange};
use siderust_spectra::spectra::loaders::ascii;
use siderust_spectra::spectra::sampled::SampledSpectrum;
...
siderust_numerics::assert_data_checksum!(
...
mod tests {
    ...
    fn pinned_sha256_matches_runtime_hash() {
        use siderust_numerics::provenance::checksum::{sha256, to_hex};
        assert_eq!(
