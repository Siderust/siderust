...
fn horizontal_true_of_date_matches_sofa_roque_sirius_2020() {
    let jd_tt = JulianDate::from_raw_unchecked(Days::new(2_459_015.5));
...
fn horizontal_true_of_date_matches_sofa_greenwich_2024() {
    let jd_tt = JulianDate::from_raw_unchecked(Days::new(2_460_310.25));
...
fn topocentric_site_vector_matches_sofa_chain_roque_2020() {
    ...
    let topo_default: position::EquatorialMeanJ2000<Kilometer, Topocentric> =
        origin.to_center((site, jd_tt));
