...
//! Provenance metadata for sampled spectra.
//!
//! Datasets ingested into a [`crate::spectra::SampledSpectrum`] should carry a
//! [`Provenance`] record describing where the data came from, what version it
//! is, and (optionally) a checksum for reproducibility audits.

/// Where a spectrum's samples originally came from.
...
/// Full provenance record for a sampled spectrum.
...
impl Provenance {
    ...
    /// Convenience constructor for a computed spectrum.
