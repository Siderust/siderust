...
//! use siderust::qtty::*;
//!
//! let jd_ut1 = siderust::JulianDate::new(qtty::Day::new(2_451_545.0));
//! let jd_tt = siderust::JulianDate::new(qtty::Day::new(2_451_545.000_800_741));
//!
...
mod tests {
    ...
    fn roundtrip_equatorial_horizontal_is_stable() {
        let jd_ut1 = crate::time::JulianDate::new(2_451_545.0);
        let jd_tt = crate::time::JulianDate::new(2_451_545.000_800_741);
