...
impl<C: ReferenceCenter, K: Kind, U: Distance> Transform<Vector<C, frames::ICRS, U, K>> for Vector<C, frames::Ecliptic, U, K> {
...
impl<C: ReferenceCenter, K: Kind, U: Distance> Transform<Vector<C, frames::ICRS, U, K>> for Vector<C, frames::Equatorial, U, K> {
    fn transform(&self, _jd: crate::units::JulianDay) -> Vector<C, frames::ICRS, U, K> {
