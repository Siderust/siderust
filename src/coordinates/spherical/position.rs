...
mod tests {
    ...
    fn test_spherical_coord_creation() {
        let coord = ICRS::new(Degrees::new(45.0), Degrees::new(90.0), 1.0);
    ...
    fn test_spherical_coord_to_string() {
        let coord = GCRS::new(Degrees::new(30.0), Degrees::new(60.0), 1000.0);
    ...
    fn test_spherical_coord_zero_values() {
        let coord = HCRS::new(Degrees::new(0.0), Degrees::new(0.0), 0.0);
    ...
    fn test_spherical_coord_precision() {
        let coord = ICRS::new(Degrees::new(90.654321), Degrees::new(45.123456), 1234.56789);
