...
//! Body-chain resolution for DE441 ephemeris.
//!
//! ## Responsibility
//!
...
// ── Physical constants (single source of truth: qtty + DE441 header) ─────

/// Earth/Moon mass ratio embedded in the DE441 header.
///
/// This value is specific to DE441 and is not a general physical constant.
