...
/// Finds periods where Sun altitude is below `threshold_deg`.
...
/// Finds periods where Sun altitude is above `threshold_deg`.
...
/// Finds periods where Sun altitude is within `[min_altitude, max_altitude]`.
