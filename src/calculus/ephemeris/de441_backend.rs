...
//! DE441 ephemeris backend implementing the [`Ephemeris`] trait.
//!
//! This backend is available when the `de441` Cargo feature is enabled.
//! It uses JPL DE441 Chebyshev polynomial data embedded at compile time,
//! covering the Sun, Earth-Moon barycenter and Moon from the DE441 part-2
//! kernel (roughly modern/future epochs).

use super::{AuPerDay, Ephemeris};
use crate::calculus::de441::bodies;
...
/// DE441 ephemeris backend (requires `de441` feature).
///
...
pub struct De441Ephemeris;

impl Ephemeris for De441Ephemeris {
    #[inline]
    fn sun_barycentric(
        jd: JulianDate,
