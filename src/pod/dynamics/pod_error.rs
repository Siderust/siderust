...
///
/// ```
/// use siderust::pod::dynamics::PodDynamicsError;
///
...
pub enum PodDynamicsError {
    ...
    /// force-model stack.
    #[error(transparent)]
    Dynamics(#[from] crate::pod::dynamics::DynamicsError),
