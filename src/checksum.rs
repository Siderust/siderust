...
//!
//! ```text
//! cargo test -p siderust data::checksum::dev::print_hashes -- --nocapture --ignored
//! ```
//!
...
macro_rules! assert_data_checksum {
    ($name:literal, $data:expr, $expected_hex:literal) => {
        ...
        const _: () = $crate::checksum::assert_sha256_eq($name, $data, $expected_hex);
    };
}
...
pub(crate) mod dev {
    ...
    ///
    /// ```text
    /// cargo test -p siderust data::checksum::dev::print_hashes \
    ///     -- --nocapture --ignored
    /// ```
    #[test]
    ...
    fn print_hashes() {
        let datasets: &[(&str, &[u8])] = &[
            (
                "siderust/data/o3trans.dat",
                include_bytes!("atmosphere/o3trans.dat"),
            ),
            (
                "siderust/data/passbands/bessell1990/U.dat",
                include_bytes!("photometry/passbands/bessell1990/U.dat"),
            ),
            (
                "siderust/data/passbands/bessell1990/B.dat",
                include_bytes!("photometry/passbands/bessell1990/B.dat"),
            ),
            (
                "siderust/data/passbands/bessell1990/V.dat",
                include_bytes!("photometry/passbands/bessell1990/V.dat"),
            ),
            (
                "siderust/data/passbands/bessell1990/R.dat",
                include_bytes!("photometry/passbands/bessell1990/R.dat"),
            ),
            (
                "siderust/data/passbands/bessell1990/I.dat",
                include_bytes!("photometry/passbands/bessell1990/I.dat"),
            ),
        ];
