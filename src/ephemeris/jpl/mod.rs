...
use crate::ephemeris::{AuPerDay, Ephemeris, EphemerisError};
...
/// The public crate surface typically exposes concrete aliases such as
/// [`crate::ephemeris::De440Ephemeris`] and [`crate::ephemeris::De441Ephemeris`].
///
/// # Example
/// ```rust,ignore
/// use siderust::ephemeris::{De440Ephemeris, Ephemeris};
///
/// let _ = De440Ephemeris::sun_barycentric(siderust::J2000);
/// ```
