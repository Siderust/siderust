...
//! # VSOP87A Heliocentric Rectangular Coordinates (Generated Data)
//!
//! ## Scientific scope
//!
//! This file contains the machine-generated coefficient tables for the
//! VSOP87A solution: heliocentric ecliptic rectangular coordinates
//! (X, Y, Z) for all eight major planets, referred to the mean ecliptic
...
//!   `vsop87a_x`, `vsop87a_y`, `vsop87a_z`.
//! - Each method delegates to [`super::vsop87_impl::position`] with
//!   the planet-specific coefficient slices.
//! - The top-level `vsop87a` method on each planet is generated by the
//!   `impl_vsop87_for_planet!` macro in `vsop87_trait.rs`.
//! - Coefficient source: original VSOP87A data file from the IMCCE archive.
//!
//! ## References
//!
...
#[rustfmt::skip]
mod vsop_data {
    include!(concat!(env!("CARGO_MANIFEST_DIR"), "/src/data/compiled/vsop87a.rs"));
}
use vsop_data::*;
