...
//! use siderust::coordinates::{spherical::Direction, frames::Equatorial, };
...
//!     Direction::<Equatorial>::new(88.792939*DEG, 7.407064*DEG),
...
//!     Direction::<Equatorial>::new(23.123*DEG, -5.321*DEG),
//!     ModifiedJulianDate::new(60200.0).to_julian_day(),
//! );
//! ```
//!
