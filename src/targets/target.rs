...
mod tests {
    ...
    fn test_target_get_position() {
        ...
        assert_eq!(retrieved_position.radial_distance, 400.0);
    }
    ...
    fn test_target_update() {
        ...
        assert_eq!(target.position.radial_distance, 800.0);
    ...
    fn test_target_clone() {
        ...
        assert_eq!(target1.position.radial_distance, target2.position.radial_distance);
    ...
    fn test_target_edge_cases() {
        ...
        assert_eq!(target.position.radial_distance, 0.0);
        ...
        assert_eq!(target.position.radial_distance, 1e6);
    }
